...
for row in csv_f:
    ...
    #print nID, bench_name, bench_title
    if bench_name == bench_title :
        #bench_title = benchmark_name
        if nID != original_nID : 
            #original_pID = pID
            original_nID = nID
            #print nID, original_nID
...
#print feature_set    
with open('dataset.csv','a+') as myfile: #you can modify output to train.csv or test.csv based on your processing
