...
int main(int argc, char *argv[])
{
  printf("WG size of kernel 1 = %d, WG size of kernel 2= %d X %d\n", MAXBLOCKSIZE, BLOCK_SIZE_XY, BLOCK_SIZE_XY);
...
#else
              m = (float*)xplacer_malloc(Size * Size * sizeof(float), Managed);
#endif
              break;
            case 'f': // platform
              i++;
    ...
    xplacer_free(m, CPU);
#else
    xplacer_free(m, Managed);
#endif
#if adv1 == 0
    xplacer_free(a, CPU);
#else
    xplacer_free(a, Managed);
#endif
#if adv2 == 0
    xplacer_free(b, CPU);
#else
    xplacer_free(b, Managed);
#endif
}
/*------------------------------------------------------
 ** PrintDeviceProperties
...
#elif adv1 == 3
	cudaMemAdvise(a,Size * Size * sizeof(float), cudaMemAdviseSetPreferredLocation, 0);
#elif adv1 == 4
	cudaMemAdvise(a,Size * Size * sizeof(float), cudaMemAdviseSetAccessedBy, 0);
#elif adv1 == 5
	cudaMemAdvise(a,Size * Size * sizeof(float), cudaMemAdviseSetPreferredLocation, cudaCpuDeviceId);
#elif adv1 == 6
	cudaMemAdvise(a,Size * Size * sizeof(float), cudaMemAdviseSetAccessedBy, cudaCpuDeviceId);
#endif
...
#endif
#if adv2 == 2
	cudaMemAdvise(b, Size * sizeof(float), cudaMemAdviseSetReadMostly, 0);
#elif adv2 == 3
...
#elif adv2 == 5
	cudaMemAdvise(b, Size * sizeof(float), cudaMemAdviseSetPreferredLocation, cudaCpuDeviceId);
#elif adv2 == 6
	cudaMemAdvise(b, Size * sizeof(float), cudaMemAdviseSetAccessedBy, cudaCpuDeviceId);
#endif
...
#endif
#if adv3 == 2
 	cudaMemAdvise(m, Size * Size * sizeof(float), cudaMemAdviseSetReadMostly, 0);
#elif adv3 == 3
 	cudaMemAdvise(m, Size * Size * sizeof(float), cudaMemAdviseSetPreferredLocation, 0);
#elif adv3 == 4
 	cudaMemAdvise(m, Size * Size * sizeof(float), cudaMemAdviseSetAccessedBy, 0);
#elif adv3 == 5
 	cudaMemAdvise(m, Size * Size * sizeof(float), cudaMemAdviseSetPreferredLocation, cudaCpuDeviceId);
#elif adv3 == 6
 	cudaMemAdvise(m, Size * Size * sizeof(float), cudaMemAdviseSetAccessedBy, cudaCpuDeviceId);
#endif
}
...
void ForwardSub()
{
	...
	cudaMalloc((void **) &m_cuda, Size * Size * sizeof(float));
        xplacer_memcpy((void**)&m_cuda, m, Size * Size * sizeof(float),cudaMemcpyHostToDevice, false);
#else
        xplacer_memcpy((void**)&m_cuda, m, Size * Size * sizeof(float),cudaMemcpyHostToDevice, true);
#endif
#if adv1 == 0
	cudaMalloc((void **) &a_cuda, Size * Size * sizeof(float));
        xplacer_memcpy((void**)&a_cuda, a, Size * Size * sizeof(float),cudaMemcpyHostToDevice, false);
#else
        xplacer_memcpy((void**)&a_cuda, a, Size * Size * sizeof(float),cudaMemcpyHostToDevice, true);
#endif
#if adv2 == 0	
	cudaMalloc((void **) &b_cuda, Size * sizeof(float));	
        xplacer_memcpy((void**)&b_cuda, b, Size * sizeof(float),cudaMemcpyHostToDevice, false);
#else
        xplacer_memcpy((void**)&b_cuda, b, Size * sizeof(float),cudaMemcpyHostToDevice, true);
#endif

	// copy memory t(float*)o GPU
...
//	cudaMemcpy(m, m_cuda, Size * Size * sizeof(float),cudaMemcpyDeviceToHost );
        xplacer_memcpy((void**)&m, m_cuda, Size * Size * sizeof(float),cudaMemcpyDeviceToHost,false);
	cudaFree(m_cuda);
#endif
#if adv1 == 0
	//cudaMemcpy(a, a_cuda, Size * Size * sizeof(float),cudaMemcpyDeviceToHost );
        xplacer_memcpy((void**)&a, a_cuda, Size * Size * sizeof(float),cudaMemcpyDeviceToHost,false);
	cudaFree(a_cuda);
#endif
#if adv2 == 0
//	cudaMemcpy(b, b_cuda, Size * sizeof(float),cudaMemcpyDeviceToHost );
        xplacer_memcpy((void**)&b, b_cuda, Size * sizeof(float),cudaMemcpyDeviceToHost,false);
	cudaFree(b_cuda);
#endif
}
