...
df1 = pd.read_csv("./ip-128-115-246-7-kernel-level-measurement/dataset.csv")
df2 = pd.read_csv("./ip-128-115-246-7-data-level-measurement/GPUTrace.csv")

df1 = df1.groupby(["InputData","Kernel"], as_index=False).mean()
...
df3.to_csv("mergedDataSet-ip-128-115-246-7.csv",index=False)
